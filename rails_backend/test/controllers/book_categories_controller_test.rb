...
class BookCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_category" do
    assert_difference("BookCategory.count") do
      post book_categories_url, params: { book_category: { title: @book_category.title } }, as: :json
    end
  ...
  test "should update book_category" do
    patch book_category_url(@book_category), params: { book_category: { title: @book_category.title } }, as: :json
    assert_response :success
  end
