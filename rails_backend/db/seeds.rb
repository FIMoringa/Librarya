...
books = Book.create([
    ...
    { title: "The Lord of the Rings", isbn: "9780547928227", author: "J.R.R. Tolkien", price: 10.99, description: "The Lord of the Rings is an epic high fantasy novel written by English author and scholar J. R. R. Tolkien. The story began as a sequel to Tolkien's 1937 fantasy novel The Hobbit, but eventually developed into a much larger work. Written in stages between 1937 and 1949, The Lord of the Rings is one of the best-selling novels ever written, with over 150 million copies sold.", year: 1954 },
    { title: "The Silmarillion", isbn: "9780547928227", author: "J.R.R. Tolkien", price: 10.99, description: "The Silmarillion is a collection of tales set in the fictional world of Arda, created by J. R. R. Tolkien. The Silmarillion was published in 1977, seven years after Tolkien's death, and is a compilation of earlier and uncollected works, with some material written specifically for the book. It is the first published part of the legendarium, and is the source of much of the material in The Lord of the Rings and The Hobbit.", year: 1977 },
])
